...
$(window).on("load", function () {
  // Begin DATA Init
  document.getElementById("totalpopulation").innerHTML = (totalPopulation/1000000000).toFixed(2) + 'B';
  document.getElementById("fertility").innerHTML = fertility;
  document.getElementById("mortaility").innerHTML = mortaility;
  ...
  var analyticsBarChartOptions = {
    ...
    series: [{
      name: 'Population',
      data: [...populationDataValues]
    }],
    xaxis: {
      categories: [...populationDataYears],
      axisBorder: {
        show: false
      },
      axisTicks: {
